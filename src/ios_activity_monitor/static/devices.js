// Apple internal ProductType → marketing name.
// Source: cross-referenced from public iOS/iPadOS device databases.

window.APPLE_DEVICES = {
  // ── iPhone ──────────────────────────────────────────
...
window.lookupDevice = function (productType) {
  return window.APPLE_DEVICES[productType] || null;
};
